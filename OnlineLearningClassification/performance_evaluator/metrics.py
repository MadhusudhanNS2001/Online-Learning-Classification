...
import numpy as np
import pandas as pd
from sklearn.metrics import average_precision_score, roc_auc_score as ras, cohen_kappa_score
...
AVAILABLE_METRICS = {
    ...
    'kappa_score': 'Kappa Score',
    'mcc': 'Mathews Correlation Coefficient',
}
MOST_REQUIRED = {
    'accuracy': 'Accuracy',
    'pr_auc_score': 'Precision',
    'recall': 'Sensitivity',
    'specificity': 'Specificity',
    'f1_score': "F-Score",
    'kappa_score': 'Kappa Score',
...
def format_(metric, name):
    ...
    elif name == 'kappa_score':
        overall = fmt.format(metric)
